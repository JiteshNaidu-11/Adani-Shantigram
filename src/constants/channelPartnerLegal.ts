...
export const CHANNEL_PARTNER_IDENTITY_LINE =
  "Propraise Realtors LLP – Authorized Channel Partner for Adani Realty";
...
export const COMPANY_ADDRESS =
  import.meta.env.VITE_COMPANY_ADDRESS?.trim() || "[Add company address here]";

export const COMPANY_PHONE =
  import.meta.env.VITE_COMPANY_PHONE?.trim() || "[Add phone]";

export const COMPANY_EMAIL =
  import.meta.env.VITE_COMPANY_EMAIL?.trim() || "[Add email]";

/**
 * Full legal disclaimer (exact wording for Legal Disclaimer page & full blocks).
 */
export const LEGAL_DISCLAIMER_PARAGRAPHS = [
  "This is not an official website of Adani Realty. This website belongs to Propraise Realtors LLP, an Authorized Channel Partner for Adani Realty.",
